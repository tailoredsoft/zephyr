.. zephyr:code-sample:: bluetooth_iso_bcast_secondary
   :name: Isochronous Broadcast Receive Mixer
   :relevant-api: bt_iso bluetooth

   Use the Bluetooth Low Energy Isochronous Broadcaster secondary (rx/tx) functionality.
...
This sample can be found under :zephyr_file:`samples/bluetooth/iso_bcast_secondary`
in the Zephyr tree. Use ``-DEXTRA_CONF_FILE=overlay-bt_ll_sw_split.conf`` to enable
