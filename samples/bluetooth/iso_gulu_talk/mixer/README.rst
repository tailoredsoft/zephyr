.. zephyr:code-sample:: bluetooth_iso_bcast_mixer
   :name: Isochronous Broadcast Receive Mixer
   :relevant-api: bt_iso bluetooth

   Use the Bluetooth Low Energy Isochronous Broadcaster receive and mixer functionality.
...
Used with two other sample apps as follow:
     :zephyr_file:`samples/bluetooth/iso_bcast_primary`
...
This sample can be found under :zephyr_file:`samples/bluetooth/iso_bcast_mixer` in
...
Used with the samples found under :zephyr_file:`samples/bluetooth/iso_bcast_primary`
and :zephyr_file:`samples/bluetooth/iso_bcast_secondary` in the Zephyr tree that will scan,
